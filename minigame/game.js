...
let managerConfig = {
  DATA_FILE_MD5: "4010144ec7293bbd",
  CODE_FILE_MD5: "c05119353117809c",
  GAME_NAME: "webgl",
  APPID: "wxa2e6b723c2b0a253",
      ...
      hideAfterCallmain: true,
			loadingPageConfig: {
				...
				materialConfig: {
					...
					backgroundImage: 'images/cat_scaled.jpg', // 背景图片，推荐使用小游戏包内图片；当有视频时，可作为视频加载时的封面
